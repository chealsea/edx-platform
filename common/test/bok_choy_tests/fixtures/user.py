...
class StudioUserFixture(WebAppFixture):
    """
    Create a user with editing permissions in Studio.

    This user can either be an instructor (with full editing permissions)
    or course staff (with limited editing permissions).
    """
    def __init__(self, username, password, email, course, is_instructor=True):
        pass
